    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                "chat_message" => {
                    db_update.chat_message = chat_message_table::parse_table_update(table_update)?
                }
                "entity" => db_update.entity = entity_table::parse_table_update(table_update)?,
                "item" => db_update.item = item_table::parse_table_update(table_update)?,
                ...
                "starter_area" => {
                    db_update.starter_area = starter_area_table::parse_table_update(table_update)?
                }
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.chat_message =
            cache.apply_diff_to_table::<ChatMessage>("chat_message", &self.chat_message);
        diff.entity = cache
            .apply_diff_to_table::<MapEntity>("entity", &self.entity)
        ...
        diff.player_entity = cache
            ...
            .with_updates_by_pk(|row| &row.entity_id);
        diff.starter_area =
            cache.apply_diff_to_table::<StarterArea>("starter_area", &self.starter_area);
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<MapEntity>("entity", &self.entity, event);
        ...
        callbacks.invoke_table_row_callbacks::<StarterArea>(
            "starter_area",
            &self.starter_area,
            event,
        );
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        ...
        starter_area_table::register_table(client_cache);
    }
}
