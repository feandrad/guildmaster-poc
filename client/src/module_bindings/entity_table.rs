...
use super::map_entity_type::MapEntity;
...
pub struct EntityTableHandle<'ctx> {
    imp: __sdk::TableHandle<MapEntity>,
...
impl EntityTableAccess for super::RemoteTables {
    fn entity(&self) -> EntityTableHandle<'_> {
        EntityTableHandle {
            imp: self.imp.get_table::<MapEntity>("entity"),
...
impl<'ctx> __sdk::Table for EntityTableHandle<'ctx> {
    ...
    fn iter(&self) -> impl Iterator<Item = MapEntity> + '_ {
        self.imp.iter()
    }
...
pub(super) fn register_table(client_cache: &mut __sdk::ClientCache<super::RemoteModule>) {
    let _table = client_cache.get_or_make_table::<MapEntity>("entity");
...
) -> __sdk::Result<__sdk::TableUpdate<MapEntity>> {
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        __sdk::InternalError::failed_parse("TableUpdate<MapEntity>", "TableUpdate")
            .with_cause(e)
            .into()
    })
}
...
pub struct EntityEntityIdUnique<'ctx> {
    imp: __sdk::UniqueConstraintHandle<MapEntity, u32>,
...
impl<'ctx> EntityEntityIdUnique<'ctx> {
    ...
    pub fn find(&self, col_val: &u32) -> Option<MapEntity> {
